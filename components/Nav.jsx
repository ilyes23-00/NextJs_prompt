          ...
          <div className="flex ">
            ...
            {toggleDropdown && (
              <div className="dropdown">
                <Link href='/profile' className="dorpdown_link" onClick={()=> setToggleDropdown(false)}>
                  My Profile
                </Link>
                <Link href='/create-prompt' className="dorpdown_link" onClick={()=> setToggleDropdown(false)}>
                 Create Prompt
                </Link>
